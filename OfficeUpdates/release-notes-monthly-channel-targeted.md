...
## <a name="version-1912-january-07"></a>Versione 1912: 7 gennaio
*Versione 1912 (Build 12325.20280)*
...
- È stato risolto un problema per cui gli utenti vedevano i messaggi di posta elettronica inviati a un indirizzo che in alcuni casi non corrispondeva all'indirizzo SMTP visualizzato.</div>

[//]: # (DO NOT REMOVE BUGDETAILS CONTENT END)

## <a name="version-1912-january-06"></a>Versione 1912: 6 gennaio
*Versione 1912 (Build 12325.20264)*
...
## <a name="version-1912-december-12"></a>Versione 1912: 12 dicembre
*Versione 1912 (Build 12325.20172)*
...
- Risolto un problema che causava la mancata visualizzazione di suggerimenti per i criteri usando un mittente alternativo.

- Potrebbero essere visualizzati degli spazi nelle schede contatto con il Language Pack giapponese.

- Risolto un problema per cui il percorso di una riunione veniva inaspettatamente aggiunto di nuovo alla riunione dopo averlo cancellato.
...
- Quando si menziona un utente in una scheda commento, potrebbe comparire un codice JSON.
