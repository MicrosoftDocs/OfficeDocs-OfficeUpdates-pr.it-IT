...
Queste note sulle versioni forniscono informazioni sulle nuove caratteristiche, sugli aggiornamenti della sicurezza e non relativi alla sicurezza inclusi negli aggiornamenti del Canale semestrale (mirato) per Office 365 ProPlus nel 2018.
 
> [!NOTE]
> - Di seguito vengono inoltre fornite informazioni sulle nuove caratteristiche, sugli aggiornamenti della sicurezza e non relativi alla sicurezza per Visio Pro per Office 365 e il Client desktop di Project Online.
...
### <a name="access-feature-updates"></a>Access: aggiornamenti delle funzionalità
 - **Visualizzazione di dati con nuovi grafici**: scegli tra 11 grafici e aggiungine uno a moduli e report per visualizzare meglio i dati e prendere decisioni informate. [Ulteriori informazioni](https://support.office.com/article/1a463106-65d0-4dbb-9d66-4ecb737ea7f7)
...
- **Miglioramenti di Verifica accessibilità:** Verifica accessibilità ha ricevuto aggiornamenti relativi al supporto per gli standard internazionali e consigli per rendere le tue cartelle di lavoro più accessibili. [Ulteriori informazioni](https://support.office.com/article/a16f6de0-2f39-4a2b-8bd8-5ad801426c7f)
...
### <a name="excel-non-security-updates"></a>Excel: aggiornamenti non relativi alla sicurezza
-   Consente di risolvere un problema in cui Excel può bloccarsi quando si modificano i dati di origine del grafico da un set di celle originali.
-   Consente di risolvere un problema in cui non iil ricalcolamento può non avvenire in apertura anche se è impostata la proprietà FullCalcOnLoad.  
...
- **Contrassegnare gli elementi eliminati come già letti:** ora puoi impostare tutti i messaggi eliminati come già letti. Scegli facendo clic su File \> Opzioni \> Posta \> Altro.
...
-   Consente di risolvere un problema in cui cambia la lingua di sistema su giapponese e tenta di digitare caratteri giapponesi in IDE di VBA se caricato all'interno di Outlook, bloccandosi.
...
-   Consente di risolvere un problema per cui Outlook si arresta in modo anomalo durante la risoluzione dei nomi visualizzati per gli indirizzi di posta elettronica quando l'utente compone un messaggio di posta elettronica.
...
- **Migliorata la modifica cella e barra della formula:** ora puoi utilizzare CTRL + A per selezionare il testo in una cella o barra della formula. È inoltre migliorato il supporto per emojis e altri caratteri complessi.[Ulteriori informazioni](https://support.office.com/article/1798d9d5-842a-42b8-9c99-9b7213f0040f)
- **Convertire l'input penna:** è possibile creare disegni e note a mano libera e convertirli in testo leggibile e forme nitide per creare una presentazione professionale. [Ulteriori informazioni](https://support.office.com/article/8ca00db0-4342-4bde-bbb2-92d6cb5e2e45)
...
- **Organizzazione dei percorsi di salvataggio recenti:** Project mantiene un elenco in esecuzione dei progetti salvati. Quando decidi di salvare un progetto, scegli uno dei percorsi di salvataggio recenti e prosegui con il lavoro.
...
-   Consente di risolvere un problema relativo al supporto TLS 1.2. (Nota: questo è lo stesso fix che è stato menzionato nelle note il 10 aprile e viene indicato di seguito nuovamente come parte dell'aggiornamento cumulativo settembre.)
...
-  Consente di risolvere un problema a causa del quale, all'apertura di un'applicazione, l'utente potrebbe visualizzare un messaggio sull'avvio in modalità provvisoria e quindi l'applicazione non si apre.
-  Risolti alcuni problemi di prestazioni.
...
-   Consente di risolvere un problema per cui OneDrive for Business (Groove.exe) consuma l'equivalente di CPU di un core CPU (ad esempio, il 25% su una CPU a 4 core) in Task Manager per lunghi periodi di tempo.
...
### <a name="word-non-security-updates"></a>Word: aggiornamenti non relativi alla sicurezza
-   Consente di correggere un problema per cui non è possibile aprire Word su un computer con Windows 7 se non ha [l'aggiornamento per clienti e diagnostica telemetria](https://support.microsoft.com/help/3080149/update-for-customer-experience-and-diagnostic-telemetry) installato.
