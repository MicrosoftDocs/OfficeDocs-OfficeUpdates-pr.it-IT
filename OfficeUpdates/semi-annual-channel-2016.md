...
---
# <a name="release-notes-for-semi-annual-channel-releases-in-2016"></a>Note sulla versione per le versioni del canale semi-annuale 2016

Queste note sulla versione vengono fornite informazioni sulle nuove caratteristiche, aggiornamenti di sicurezza e non correlati alla sicurezza gli aggiornamenti inclusi negli aggiornamenti di canale semi-annuale per Office 365 ProPlus nelle 2016. 
> [!NOTE]
...
## <a name="version-1605-december-13"></a>Versione 1605: 13 dicembre
*Versione 1605 (Build 6965.2115)*
...
## <a name="version-1602-december-13"></a>Versione 1602: 13 dicembre
*Versione 1602 (Build 6741.2098)*

*Questa è la versione del canale rinviata che è stato reso disponibile dopo 2016 giugno. Continuerà a essere supportato e ricevere aggiornamenti di sicurezza fino al 2017 febbraio. Ma è ora disponibile una nuova versione rinviata canale, ovvero versione 1605 (Build 6965.2115), che include le nuove funzionalità, aggiornamenti di sicurezza e aggiornamenti non correlati alla sicurezza.*
...
## <a name="version-1605-november-8"></a>Versione 1605: 8 novembre
*Versione 1605 (Build 6965.2105)*
...
## <a name="version-1602-november-8"></a>Versione 1602: 8 novembre
*Versione 1602 (Build 6741.2088)*

*Questa è la versione del canale rinviata che è stato reso disponibile dopo 2016 giugno. Continuerà a essere supportato e ricevere aggiornamenti di sicurezza fino al 2017 febbraio. Ma è ora disponibile una nuova versione rinviata canale, ovvero versione 1605 (Build 6965.2105), che include le nuove funzionalità, aggiornamenti di sicurezza e aggiornamenti non correlati alla sicurezza.*
...
## <a name="version-1605-october-11"></a>Versione 1605: Ottobre 11
*Versione 1605 (Build 6965.2092)*
...
-   Consente di risolvere un problema a causa del quale, eseguendo gesti di input penna, non è possibile deselezionare tratti casuali che sono selezionati.

### <a name="outlook-feature-updates"></a>Outlook: Aggiornamenti delle funzionalità
-   **Creazione semplificata profilo:** Un'interfaccia utente semplificata per configurare un profilo di Outlook per le cassette postali di Office 365, se l'accesso è stato eseguito con un account di Office 365.
...
## <a name="version-1602-october-11"></a>Versione 1602: Ottobre 11
*Versione 1602 (Build 6741.2081)*

*Questa è la versione del canale rinviata che è stato reso disponibile dopo 2016 giugno. Continuerà a essere supportato e ricevere aggiornamenti di sicurezza fino al 2017 febbraio. Ma è ora disponibile una nuova versione rinviata canale, ovvero versione 1605 (Build 6965.2092), che include le nuove funzionalità, aggiornamenti di sicurezza e aggiornamenti non correlati alla sicurezza.*
...
## <a name="version-1602-september-13"></a>Versione 1602: Settembre 13
*Versione 1602 (Build 6741.2071)*
...
### <a name="skype-for-business-non-security-updates"></a>Skype for Business: Aggiornamenti non della sicurezza
-   Consente di risolvere un problema a causa del quale i server Media Relay configurati per l'utilizzo del proxy http non riescono a eseguire la configurazione della chiamata.
...
## <a name="version-1509-september-13"></a>Versione 1509: Settembre 13
*Versione 1509 (Build 6001.1090)*

*Questa è la versione del canale rinviata che è stato reso disponibile dopo febbraio 2016. Continuerà a essere supportato e ricevere gli aggiornamenti di sicurezza finché 2016 ottobre. Tuttavia, una nuova versione rinviata canale è ora disponibile, ovvero versione 1602 (Build 6741.2071), che include le nuove funzionalità, aggiornamenti di sicurezza e aggiornamenti non correlati alla sicurezza.*
...
## <a name="version-1602-august-9"></a>Versione 1602: Agosto 9
...
## <a name="version-1509-august-9"></a>Versione 1509: Agosto 9
*Versione 1509 (Build 6001.1087)*

*Questa è la versione del canale rinviata che è stato reso disponibile dopo febbraio 2016. Continuerà a essere supportato e ricevere gli aggiornamenti di sicurezza finché 2016 ottobre. Tuttavia, una nuova versione rinviata canale è ora disponibile, ovvero versione 1602 (Build 6741.2063), che include le nuove funzionalità, aggiornamenti di sicurezza e aggiornamenti non correlati alla sicurezza.*
...
## <a name="version-1602-july-12"></a>Versione 1602: Luglio 12
*Versione 1602 (Build 6741.2056)*
...
## <a name="version-1509-july-12"></a>Versione 1509: Luglio 12
*Versione 1509 (Build 6001.1085)*

*Questa è la versione del canale rinviata che è stato reso disponibile dopo febbraio 2016. Continuerà a essere supportato e ricevere gli aggiornamenti di sicurezza finché 2016 ottobre. Tuttavia, una nuova versione rinviata canale è ora disponibile, ovvero versione 1602 (Build 6741.2056), che include le nuove funzionalità, aggiornamenti di sicurezza e aggiornamenti non correlati alla sicurezza.*
...
## <a name="version-1602-june-14"></a>Versione 1602: 14 giugno
*Versione 1602 (Build 6741.2048)*
...
-   Consente di risolvere un problema a causa del quale un intervallo dei nomi viene importato in modo non corretto quando si utilizza Dati \> Ottieni e trasforma \> Da tabella.
-   Consente di risolvere un problema in cui le macro vengono eseguite in modo significativamente più lento nei computer in cui è abilitata la registrazione per la dashboard di telemetria.
-   Consente di risolvere un problema a causa del quale, quando si utilizza un colore del tema e si esegue una macro o un componente aggiuntivo, la barra di stato diventa verde con il testo in grigio, rendendo difficile per l'utente la lettura dell'aggiornamento di stato sulla relativa barra.
...
-   **Calendario persiano:** calendario persiano come calendario principale o alternativo.
...
-   **Transizione morphing:** consente di creare transizioni continue tra diapositive e di inserire movimenti nelle presentazioni, al fine di enfatizzare concetti e informazioni. [Ulteriori informazioni](https://support.office.com/article/0c30ee3f-8674-4f0e-97be-89cf2892a34d)
...
-   **Inserisci API immagine:** consente di inserire immagini in Word, Excel o PowerPoint utilizzando il [metodo document.setSelectedDataAsync](https://msdn.microsoft.com/library/office/fp142145.aspx)nella raccolta comune office.js. L'API JavaScript di Word fornisce un metodo specifico dell'host denominato insertInlinePictureFromBase64() al fine di impostare immagini in linea negli oggetti di [corpo](https://msdn.microsoft.com/library/office/mt598674.aspx),[contentControl](https://msdn.microsoft.com/library/office/mt598675.aspx), [paragrafo](https://msdn.microsoft.com/library/office/mt598682.aspx)e intervallo .
...
-   Consente di aggiungere un'opzione in File \> Opzioni \> Avanzate in Word, Excel e PowerPoint per consentire agli utenti di impostare il comportamento predefinito relativo all'utilizzo della penna come mouse anziché come strumento per annotare.
...
-   Aggiungere la possibilità per il processo di aggiornamento manuale di A portata di clic di rilevare se Outlook è connesso a Exchange Server 2007 o se Business Contact Manager è installato per avvisare gli utenti di possibili problemi durante l'aggiornamento.
...
## <a name="version-1509-june-14"></a>Versione 1509: 14 giugno
*Versione 1509 (Build 6001.1082)*
...
## <a name="version-1509-may-10"></a>Versione 1509: 10 maggio
*Versione 1509 (Build 6001.1078)*
...
## <a name="version-1509-april-12"></a>Versione 1509: Aprile 12
*Versione 1509 (Build 6001.1073)*
...
## <a name="version-1509-march-8"></a>Versione 1509: Marzo 8
*Versione 1509 (Build 6001.1068)*
...
Questa è la versione iniziale di questo canale. Questa versione contiene le stesse funzionalità fornite con Office 2016 il 22 settembre 2015.

### <a name="access-security-updates"></a>Access: Aggiornamenti della sicurezza
-   Bollettino Microsoft sulla sicurezza [15-116](https://technet.microsoft.com/library/security/ms15-116): Aggiornamenti della sicurezza per Microsoft Office per risolvere l'esecuzione di codice in modalità remota (3104540)

### <a name="excel-security-updates"></a>Excel: Aggiornamenti della sicurezza
-   Bollettino Microsoft sulla sicurezza [15-099](https://technet.microsoft.com/library/security/ms15-099): Possibile esecuzione di codice in modalità remota a causa di vulnerabilità in Microsoft Office (3089664)
-   Bollettino Microsoft sulla sicurezza [15-110](https://technet.microsoft.com/library/security/ms15-110): Aggiornamenti sulla sicurezza per Microsoft Office per risolvere l'esecuzione di codice in modalità remota (3096440)
-   Bollettino Microsoft sulla sicurezza [15-116](https://technet.microsoft.com/library/security/ms15-116): Aggiornamenti della sicurezza per Microsoft Office per risolvere l'esecuzione di codice in modalità remota (3104540)
-   Bollettino Microsoft sulla sicurezza [16-004](https://go.microsoft.com/fwlink/?LinkId=717998): Aggiornamenti della sicurezza per Microsoft Office per risolvere l'esecuzione di codice in modalità remota (3124585)
...
### <a name="excel-non-security-updates"></a>Excel: Aggiornamenti non della sicurezza
-   Consente di risolvere un problema a causa del quale un utente non è in grado di visualizzare il nome del foglio quando rinomina il foglio in modalità a contrasto elevato.
-   Consente di risolvere un problema di prestazioni quando si utilizzano i filtri su dispositivi Windows 10 se è abilitata la modalità tocco o penna.
-   Consente di risolvere un problema a causa del quale la selezione di un'icona KPI in Power BI viene ignorata.
-   Consente di risolvere un problema a causa del quale l'informazione Testo alternativo viene eliminata quando si sposta un grafico in un nuovo foglio.
-   Consente di risolvere un problema a causa del quale le formule vengono corrotte quando sono utilizzate per indicare un riferimento strutturato contenente caratteri speciali.
-   Consente di risolvere un problema a causa del quale la registrazione di una macro per la creazione di una query genera un errore di compilazione.
-   Risolvere un problema per il quale, dopo l'eliminazione di una colonna nell'Editor di query, una colonna vuota viene visualizzata alla fine della tabella dopo l'aggiornamento della query.
-   Risolvere un problema per il quale si verifica un errore quando si sceglie la scheda Grafici sparkline in Analisi rapida di una tabella Query.
-   Risolvere un problema per il quale, dopo aver eseguito un operazione di copia e incolla in una tabella Query, non è possibile aggiornare la query utilizzando il riquadro Query della cartella di lavoro.
...
### <a name="onenote-non-security-updates"></a>OneNote: Aggiornamenti non della sicurezza
-   Consente di risolvere un problema di apertura di un blocco appunti in OneNote da OneNote Online.
-   Consente di risolvere un problema a causa del quale XPS o la stampa creata utilizzando il client desktop di Windows viene visualizzato come un simbolo X rosso nei client desktop differenti da Windows. Ciò si verifica poiché i client non supportano il rendering XPS nativo.
-   Consente di risolvere un problema che blocca OneNote quando viene selezionato per due volte lo stesso colore per un bordo.
-   Consente di risolvere un problema con Office 365 Business, per il quale, quando si tenta di utilizzare OneNote con SharePoint, viene visualizzato un messaggio di errore che indica agli utenti che devono eseguire l'aggiornamento a una versione diversa di Office.
-   Risolvere un problema per Surface Pro 3 per il quale l'anteprima della registrazione dei video non mostra cosa viene registrato.
...
### <a name="powerpoint-non-security-updates"></a>PowerPoint: Aggiornamenti non relativi alla sicurezza
-   Consente di risolvere un problema a causa del quale la topologia dello schermo dell'utente, come duplicato, non viene ripristinata dopo aver chiuso la modalità presentazione.
-   Consente di risolvere un problema a causa del quale l'utente non è in grado di nascondere la barra degli strumenti tocco della modalità presentazione su un monitor esterno quando utilizza la modalità tocco per far avanzare le diapositive nella visualizzazione Relatore.
-   Consente di risolvere un problema a causa del quale i file temporanei non vengono eliminati dalla cartella Internet temporanea dopo aver chiuso un file PowerPoint che era stato aperto da una condivisione file.
-   Consente di risolvere un problema a causa del quale l'unione delle modifiche ha esito negativo quando vengono aggiunte delle note a una diapositiva.
-   Consente di risolvere un problema a causa del quale il tema non utilizzato non viene eliminato dopo l'unione delle modifiche del tema a una presentazione.
-   Consente di risolvere un problema a causa del quale viene visualizzata una riga aggiuntiva nella parte inferiore della tabella dopo l'unione delle modifiche per una tabella in cui diversi utenti hanno eliminato e aggiunto righe.
-   Consente di risolvere un problema a causa del quale l'utente riceve un messaggio di errore quando tenta di aprire un file da SharePoint quando Internet Explorer è in modalità protetta.

### <a name="project-security-updates"></a>Project: Aggiornamenti della sicurezza
-   Bollettino Microsoft sulla sicurezza [15-116](https://technet.microsoft.com/library/security/ms15-116): Aggiornamenti della sicurezza per Microsoft Office per risolvere l'esecuzione di codice in modalità remota (3104540)

### <a name="project-non-security-updates"></a>Project: Aggiornamenti non della sicurezza
-   Consente di risolvere un problema a causa del quale la modifica di un calendario organizzazione da un browser diverso da Internet Explorer provoca un errore nell'apertura di Project.
-   Consente di risolvere un problema a causa del quale la data di fine impegnata viene mostrata come 01/01/84 per impieghi nuovi.
...
### <a name="skype-for-business-security-updates"></a>Skype for Business: Aggiornamenti della sicurezza
-   Bollettino Microsoft sulla sicurezza [15-116](https://technet.microsoft.com/library/security/ms15-116): Aggiornamenti della sicurezza per Microsoft Office per risolvere l'esecuzione di codice in modalità remota (3104540)
-   Bollettino Microsoft sulla sicurezza [15-123](https://technet.microsoft.com/library/security/ms15-123): Aggiornamento della sicurezza per Skype for Business e Microsoft Lync per risolvere la divulgazione di informazioni (3105872)
-   Bollettino Microsoft sulla sicurezza [15-128](https://go.microsoft.com/fwlink/?LinkId=690559): Aggiornamento della sicurezza di Microsoft Graphics Component per risolvere l'esecuzione di codice in modalità remota (3104503)

### <a name="skype-for-business-non-security-updates"></a>Skype for Business: Aggiornamenti non della sicurezza
-   Consente di risolvere un problema a causa del quale un utente dovrebbe accedere automaticamente anziché tramite la richiesta di credenziali.
-   Consente di risolvere un problema a causa del quale, quando un utente dispone di più monitor, viene condiviso il monitor errato durante una sessione di condivisione dello schermo.
-   Consente di risolvere un problema a causa del quale non è possibile eseguire la condivisione app, soprattutto durante i periodi con maggiore traffico.
-   Consente di risolvere un problema a causa del quale Skype for Business si arresta, nel caso in cui viene avviato come prima app in seguito all'installazione di Office 2016.
-   Consente di risolvere un problema relativo ai disturbi audio nei dispositivi con due microfoni input.
-   Risolvere un problema per il quale gli utenti non possono partecipare a una riunione dopo il ripristino di un computer portatile dalla modalità sospensione e prima che il client Skype abbia effettuato di nuovo l'accesso.
...
### <a name="visio-security-updates"></a>Visio: Aggiornamenti della sicurezza
-   Bollettino Microsoft sulla sicurezza [15-081](https://technet.microsoft.com/library/security/ms15-081): Possibile esecuzione di codice in modalità remota a causa di vulnerabilità in Microsoft Office (3080790)
-   Bollettino Microsoft sulla sicurezza [15-116](https://technet.microsoft.com/library/security/ms15-116): Aggiornamenti della sicurezza per Microsoft Office per risolvere l'esecuzione di codice in modalità remota (3104540)
-   Bollettino Microsoft sulla sicurezza [16-004](https://go.microsoft.com/fwlink/?LinkId=717998): Aggiornamenti della sicurezza per Microsoft Office per risolvere l'esecuzione di codice in modalità remota (3124585)
...
-   Bollettino Microsoft sulla sicurezza [15-081](https://technet.microsoft.com/library/security/ms15-081): Possibile esecuzione di codice in modalità remota a causa di vulnerabilità in Microsoft Office (3080790)
-   Bollettino Microsoft sulla sicurezza [15-116](https://technet.microsoft.com/library/security/ms15-116): Aggiornamenti della sicurezza per Microsoft Office per risolvere l'esecuzione di codice in modalità remota (3104540)
-   Bollettino Microsoft sulla sicurezza [15-131](https://go.microsoft.com/fwlink/?LinkId=699410): Aggiornamenti della sicurezza per Microsoft Office per risolvere l'esecuzione di codice in modalità remota (3116111)
-   Bollettino Microsoft sulla sicurezza [16-004](https://go.microsoft.com/fwlink/?LinkId=717998): Aggiornamenti della sicurezza per Microsoft Office per risolvere l'esecuzione di codice in modalità remota (3124585)
-   Bollettino Microsoft sulla sicurezza [16-015](https://go.microsoft.com/fwlink/?LinkId=722214): Aggiornamenti della sicurezza per Microsoft Office per risolvere l'esecuzione di codice in modalità remota (3134226)

### <a name="word-non-security-updates"></a>Word: Aggiornamenti non della sicurezza
-   Consente di risolvere un problema relativo alla stampa unione a causa del quale nella finestra di dialogo "Selezione destinatari" non viene visualizzato il numero corretto di voci quando l’origine è Excel.
-   Consente di risolvere un problema a causa del quale, quando si tenta di stampare un documento con una casella di testo incorporata, l'utente riceve un messaggio di errore che indica che la quantità di spazio su disco o di memoria di Word è insufficiente.
-   Consente di risolvere un problema a causa del quale un utente potrebbe visualizzare contenuti duplicati durante la creazione condivisa in tempo reale con un altro utente.
-   Consente di risolvere un problema relativo alla memoria per i documenti che contengono una grande quantità di immagini ad alta risoluzione.
-   Consente di risolvere un problema a causa del quale l'evento WindowsSelctionChange non si attiva quando l'utente fa clic con il pulsante destro del mouse.
-   Consente di risolvere un problema a causa del quale un trattino d'unione viene visualizzato come un quadrato quando si utilizza lo stesso tipo di carattere.
-   Consente di risolvere un problema in cui la numerazione delle note a piè di pagina non corrisponde tra la visualizzazione in Word e la stampa quando si stampa in background un documento le cui note a piè di pagina sono impostate su "Riavvia la numerazione a ogni pagina".
-   Risolvere un problema per il quale la creazione condivisa in tempo reale non funziona con i file archiviati in OneDrive, anche quando l'utente non è visibile agli altri utenti mentre apporta modifiche in tempo reale e quando non sono disponibili informazioni sulla presenza.
-   Risolvere un problema per il quale Word si arresta in modo anomalo durante la creazione condivisa in tempo reale di un documento aperto da SharePoint o OneDrive.
...
### <a name="office-suite-non-security-updates"></a>Famiglia di prodotti Office: Aggiornamenti non della sicurezza
-   Consente di risolvere un problema a causa del quale l'esecuzione di query Line.ForeColor.RGB con VBA, per una riga con il riempimento impostato su Automatico, restituisce sempre un valore di bianco, anche se il colore non è effettivamente bianco.
-   Consente di modificare il metodo di trasporto predefinito per scaricare gli aggiornamenti in background da cache/BITS a HTTP.
-   Consente di risolvere un problema causato da errori di licenza durante la procedura di aggiornamento automatico, che non consentono all'utente di installare Office.
-   Consente di risolvere l'errore 0x80070005 durante l'attivazione dell'aggiornamento a Office 2016 su un computer Windows 7 OEM dotato del kit di preinstallazione di Office eseguito in modalità di controllo.
-   Consente di risolvere un problema per il quale all'utente viene richiesto più volte di effettuare l'accesso quando tenta di aprire i file da SharePoint Online.
