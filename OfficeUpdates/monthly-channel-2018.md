...
## <a name="version-1809-october-16"></a>Versione 1809: Ottobre 16
...
-  Risolti diversi problemi di prestazioni.


## <a name="version-1809-october-9"></a>Versione 1809: Ottobre 9
...
- **Le icone della barra multifunzione hanno un nuovo aspetto** Non preoccuparti, tutto funziona allo stesso modo. Inoltre, si adattano perfettamente a schermi di tutte le dimensioni. [Ulteriori informazioni](https://support.office.com/article/c6bc4cd8-d151-41d3-8276-fc7c9975eb79)
- **Convertitore Equation Editor** Il convertitore consente agli utenti di convertire le equazioni create tramite Microsoft Equation Editor nel formato Office Math ML per abilitarne la modifica.
...
### <a name="outlook-feature-updates"></a>Outlook: aggiornamenti delle funzionalità
 - **Impostazione predefinita di Ricorrenza:** nella finestra di dialogo Ricorrenza appuntamento (alla voce "Intervallo di ricorrenza"), "Termina entro" è l'impostazione predefinita (anziché "Nessuna data di fine") ed è la prima impostazione elencata, e una data predefinita viene impostata.
...
### <a name="project-feature-updates"></a>Project: aggiornamenti delle funzionalità
 ...
 - **Un nuovo metodo per gestire gli sprint:** adotta un approccio diretto nell'utilizzo delle bacheche attività. Accedendo a Gestisci sprint, puoi aggiungere e rimuovere gli sprint mentre stai lavorando a un progetto.
...
### <a name="outlook-feature-updates"></a>Outlook: aggiornamenti delle funzionalità
 ...
 - **Visualizzazione di 3 fusi orari:** se devi pianificare una riunione in fusi orari diversi, basta aggiungere più fusi orari al calendario per visualizzare facilmente la disponibilità di tutti i partecipanti e l'orario adatto a tutti. [Ulteriori informazioni](https://support.office.com/article/5ab3e10e-5a6c-46af-ab48-156fedf70c04)
 - **Condivisione del calendario semplificata:** la condivisione dei calendari è diventata più semplice e i calendari condivisi dalla versione desktop di Outlook sono ora disponibili anche in Outlook Mobile. [Ulteriori informazioni](https://support.office.com/article/353ed2c1-3ec5-449d-8c73-6931a0adab88)

### <a name="outlook-non-security-updates"></a>Outlook: aggiornamenti non relativi alla sicurezza
- Modifica il testo in un invito per condividere un calendario da "Apri questo calendario" ad "Accetta".

### <a name="powerpoint-feature-updates"></a>PowerPoint: aggiornamenti delle funzionalità
 - **Chatta con i coautori mentre apporti modifiche:** collabora in modo più efficiente chattando con i coautori senza dover uscire da PowerPoint. [Ulteriori informazioni](https://support.office.com/article/1ecc6c7f-0b02-4baa-b9d9-c9d67023bedd)
...
### <a name="project-non-security-updates"></a>Project: aggiornamenti non relativi alla sicurezza
 - Risolve un problema a causa del quale Project potrebbe arrestarsi in modo anomalo la prima volta che si salva un progetto in Project Web App.


### <a name="visio-feature-updates"></a>Visio: aggiornamenti delle funzionalità
 - **Diagrammi di base:** i modelli di organigramma, brainstorming e SDL hanno nuovi diagrammi di base per farti cominciare rapidamente.

### <a name="word-feature-updates"></a>Word: aggiornamenti delle funzionalità
 - **Chatta con i coautori mentre apporti modifiche:** collabora in modo più efficiente chattando con i coautori senza dover uscire da Word. [Ulteriori informazioni](https://support.office.com/article/1ecc6c7f-0b02-4baa-b9d9-c9d67023bedd)
 - **Digitazione senza mani:** usa i comandi vocali per creare documenti con la semplice dettatura. Non c'è bisogno di digitare. [Ulteriori informazioni](https://support.office.com/article/d4fd296e-8f15-4168-afec-1f95b13a6408)
...
### <a name="word-feature-updates"></a>Word: aggiornamenti delle funzionalità
-   **Individuare e risolvere i problemi riscontrati negli strumenti di correzione:** il riquadro editor ora visualizza una panoramica di problemi di correzione riscontrati nel documento, ponendo l’attenzione su quelli più rilevanti per l'utente.
...
-   **Ordinare messaggi di posta elettronica con facilità:** grazie ai tuoi commenti, offriamo di nuovo la possibilità di ordinare l'elenco dei messaggi e il filtro Da leggere per gli utenti che non usano Posta in arrivo evidenziata.
...
-   **Più stencil per diagrammi aziendali:** utilizza forme moderne, confronta e contrasta dati con un diagramma di Venn o disegna diagrammi circolari, di matrice o a piramide per arricchire i contenuti.
-   **Sincronizzare il diagramma di origine:** quando modifichi un diagramma visualizzatore dati in Visio, puoi aggiornare i dati di origine di Excel collegati con il contenuto del diagramma più recente.
...
### <a name="excel-feature-updates"></a>Excel: aggiornamenti delle funzionalità
-   **Conversione delle icone SVG in forme:** trasforma tutte le immagini SVG e le icone in forme di Office in modo da poter cambiare il loro colore, le dimensioni o la texture.
...
### <a name="visio-feature-updates"></a>Visio: aggiornamenti delle funzionalità
-   **Usare i modelli di Excel per l’esportazione in un diagramma di Visio:** consente di passare ai diagrammi di flusso di Visio. Immetti i dati in uno dei modelli di Process Map Excel ed esportali in Visio per creare automaticamente il diagramma. Richiede Visio Pro per Office 365.
