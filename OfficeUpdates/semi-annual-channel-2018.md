...
Queste note sulle versioni forniscono informazioni sulle nuove caratteristiche, sugli aggiornamenti di sicurezza e non relativi alla sicurezza inclusi negli aggiornamenti del Canale semestrale per Office 365 ProPlus nel 2018. 

> [!NOTE]
> - Di seguito vengono fornite informazioni sulle nuove caratteristiche, sugli aggiornamenti di sicurezza e non relativi alla sicurezza per Visio Pro per Office 365 e Project Online Desktop Client.
...
## <a name="version-1803-october-9"></a>Versione 1803: 9 ottobre
...
### <a name="office-suite-security-updates"></a>Famiglia di prodotti Office: aggiornamenti di sicurezza
-   [CVE-2018-8332](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8332): vulnerabilità relativa all'esecuzione di codice remoto grafica in Microsoft Word
...
-   **Accedere rapidamente a siti e gruppi:** utilizza il menu File per usare i documenti archiviati nei siti e gruppi più usati.
...
-   [CVE-2018-0907](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0907): bypass delle funzionalità di sicurezza di Microsoft Office Excel
...
-   [CVE-2018-8246](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8246): vulnerabilità relativa alla diffusione di informazioni di Microsoft Excel
...
-   Consente di risolvere un problema in cui viene visualizzato l'anno errato quando si utilizza il calendario giapponese nel formato data della cella.
...
-   Consente di correggere un problema a causa nel quale a volte un'operazione di raggruppamento (o di annullamento del raggruppamento) in una tabella pivot di Excel potrebbe provocare un arresto anomalo.
-   Consente di risolvere un problema in cui le azioni relative ai grafici potrebbero causare un arresto anomalo di Excel.
-   Consente di risolvere un problema a causa del quale il componente aggiuntivo Power View viene inavvertitamente disattivato per alcuni utenti.
-   Consente di risolvere un problema in cui i file temporanei creati tramite il ripristino automatico durante il recupero di un documento non vengono mai eliminati.
...
-   Consente di risolvere un errore che si verifica quando si salva una cartella di lavoro utilizzando File \> Salva con nome e causa del quale il nome file viene visualizzato vuoto oppure troncato nella finestra di dialogo di salvataggio del file.
...
-   **Scheda del profilo:** mostra i dettagli più importanti di persone e gruppi su un computer desktop, sul Web o tramite un'app per dispositivi mobili.
...
-   **Download degli allegati cloud:** quando salvi oppure trascini gli allegati di OneDrive nel computer, il file viene scaricato automaticamente.
-   **Suoni utili per migliorare l'accessibilità:** attiva gli avvisi audio per ottenere assistenza durante il lavoro. Sono disponibili in File \> Opzioni \> Accessibilità. Non sono necessari componenti aggiuntivi. [Ulteriori informazioni](https://support.office.com/article/49fda9be-cce5-4c72-a87f-b11000197f5f)
...
-   **Accedere rapidamente ai gruppi più utilizzati:** i gruppi con i quali interagirai più probabilmente ora vengono visualizzati nella parte superiore dell'elenco in Gruppi nel riquadro delle cartelle.
...
-   [CVE-2018-0850](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0850): vulnerabilità relativa all'elevazione di privilegi in Microsoft Outlook
-   [CVE-2018-0852](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0852): vulnerabilità relativa al danneggiamento della memoria di Microsoft Outlook
-   [CVE-2018-8150](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8150): vulnerabilità relativa al bypass delle funzionalità di sicurezza di Microsoft Outlook
...
-   Consente di risolvere un problema a causa del quale, quando si passa alla cartella Posta in uscita o Posta inviata, Outlook si arresta in modo anomalo.
...
-   Consente di risolvere un problema a causa del quale alcuni utenti non ricevono funzionalità di supporto che sono state abilitate dall'amministratore tenant.
...
-   **Microsoft Translator:** è possibile tradurre parole e frasi in un'altra lingua con Microsoft Translator nella scheda Revisione della barra multifunzione.
-   **Animazioni 3D:** dai vita a modelli 3D con animazioni, ad esempio con movimenti graduali, spostamenti e rotazioni.
-   **Convertire le icone SVG in forme:** trasforma tutte le immagini e le icone SVG in forme di Office così puoi cambiarne colore, dimensioni o trama.
...
-   **Durante la tua assenza:** PowerPoint mostra all'utente chi ha modificato la presentazione condivisa a partire dall'ultima visita.
...
-   Consente di risolvere un problema a causa del quale il riquadro con le informazioni sul file recuperato viene visualizzato in modo errato quando è attivo il salvataggio automatico.
-   Consente di risolvere un problema a causa del quale le informazioni di accesso non vengono visualizzate, impedendo a un utente di accedere a un file.
...
-   **Gestire un'attività in Planner:** collega un’attività progetto a Planner e crea una relativa pianificazione. Suddividi l'attività in sottoattività, aggiungi un team, assegna attività e gestisci il lavoro su una bacheca delle attività.

### <a name="project-non-security-updates"></a>Project: aggiornamenti non relativi alla sicurezza
-   Consente di correggere un problema a causa del quale, se un'attività è divisa con una risorsa costo, la risorsa costo non viene aggiornata correttamente e il costo viene perso.
-   Consente di correggere un problema a causa del quale in Visualizzazione sequenza temporale, nella finestra di dialogo Aggiungi attività esistenti alla sequenza temporale, verrebbero visualizzate solo le attività della prima attività di riepilogo.
...
-   Risolve un problema di perdita del codice VBA dai progetti.
...
### <a name="publisher-non-security-updates"></a>Publisher: aggiornamenti non relativi alla sicurezza
...
-   Consente di risolvere un problema a causa del quale l'aggiunta degli utenti selezionando "Chiamata Skype" in una riunione causa un errore.
...
-   Modifica il valore predefinito di EnableRestoreOAuthUsedKeyWhenUsingCachedWebTicket su TRUE.
...
-   Aggiunge il pulsante di trasferimento di chiamata all'interfaccia utente di avviso per chiamate PSTN in arrivo.
-   Comunica agli utenti che chiamate e chat vengono inviate ai team quando le opzioni ChatDefaultClient e CallDefaultClient sono impostate su Team.
-   Visualizza la presenza dell'utente come non in linea quando non è in riunione e risulta non attivo su Skype for Business e l’opzione per partecipare alla riunione è impostata su Native Limited Client.
-   Disattiva tutte le opzioni ad eccezione di Apri e Chiudi, quando Skype for Business è ridotto a icona nell'area di notifica.
-   Elimina le nuove chiamate e conversazioni se abilitato con telefoni Aries e RedirectClient.
-   Risolve un problema in caso di errore relativo alla data durante la ricerca di messaggi in PChat, quando il formato della data è diverso da quello statunitense (mm/gg/aa).
-   Risolve un problema in cui sia ancora possibile allegare file nelle riunioni, quando il criterio EnableExternalP2PFileTransfer è impostato su false.
...
-   Aggiunge la possibilità che gli utenti non ricevano più chiamate per conto di un gruppo di risposta.
-   Aggiunge la possibilità di mettere automaticamente in attesa le chiamate quando una chiamata è attiva in Skype for Business o Teams e viene ricevuta o avviata una nuova chiamata.
...
-   Consente di risolvere un problema a causa del quale gli utenti nella sala di attesa non ricevono notifiche in merito al divieto di partecipare a una riunione.
...
-   **Diagrammi modello database integrati**: usa il nuovo Diagramma modello database per modellare in modo accurato il database come un diagramma di Visio. Nessun componente aggiuntivo necessario.
-   **Altri stencil per diagrammi aziendali:** utilizza forme moderne, confronta e contrasta dati con un diagramma di Venn o disegna diagrammi circolari, di matrice o a piramide per arricchire i contenuti.
-   **Creare un diagramma reticolo per un sito Web:** crea rapidamente un diagramma reticolo di un sito Web con interfaccia, barra di spostamento e come interagiscono tra loro. [Ulteriori informazioni](https://support.office.com/article/2d54dc55-f5c4-49a2-85da-d649eb7fc281)
...
-   **Applicare elementi grafici dati ai diagrammi di Visualizzatore dati:** velocizza la creazione di un diagramma di Visualizzatore dati applicando automaticamente dati di forma e di elementi grafici. [Ulteriori informazioni](https://support.office.com/article/17211b46-d144-4ca2-9ea7-b0f48f0ae0a6?#apply_dg)
-   **Collaborare ai disegni:** collabora con altri utenti condividendo i disegni su OneDrive for Business o SharePoint Online. Puoi visualizzare gli utenti che stanno attualmente lavorando ai disegni, aggiungere commenti e visualizzare l'attività del file. [Ulteriori informazioni](https://support.office.com/article/413c0b5a-0d52-4ace-af85-8b9bf115bbbf)
-   **Bloccare estensioni pericolose:** per impostazione predefinita, viene impedita l'attivazione delle estensioni considerate ad alto rischio e incorporate come oggetti di pacchetti OLE, bloccandole. Queste sono, ad esempio, .exe, .vbs e .js. [Ulteriori informazioni](https://support.office.com/article/packager-activation-in-office-365-desktop-applications-52808039-4a7c-4550-be3a-869dd338d834)
...
-   **Sintassi LaTex:** crea e modifica equazioni matematiche tramite sintassi LaTeX.
-   **Suoni utili per migliorare l'accessibilità:** attiva gli avvisi audio per ottenere assistenza durante il lavoro. Sono disponibili in File \> Opzioni \> Accessibilità. Non sono necessari componenti aggiuntivi. [Ulteriori informazioni](https://support.office.com/article/49fda9be-cce5-4c72-a87f-b11000197f5f)
-   **Percorsi di file dall'account:** all'apertura o salvataggio di un file, l'elenco di posizioni è organizzato per l'account associato.
-   **Personalizzazione della penna:** scegli un set personale di penne ed evidenziatori per l'input penna. Il set personalizzato è disponibile in tutti i PC Windows.
...
-   [CVE-2018-0798](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0798): vulnerabilità relativa al danneggiamento della memoria di Microsoft Office
...
-   [CVE-2018-0802](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0802): vulnerabilità relativa al danneggiamento della memoria di Microsoft Office
...
-   Consente di correggere un problema per cui non è possibile aprire Word su un computer con Windows 7 se non sono installati l'aggiornamento per l'esperienza clienti e la diagnostica delle telemetria.
...
### <a name="office-suite-security-updates"></a>Famiglia di prodotti Office: aggiornamenti di sicurezza
-   [CVE-2017-11882](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2017-11882): vulnerabilità relativa al danneggiamento della memoria di Microsoft Office
...
-   [CVE-2018-0851](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0851): vulnerabilità relativa al danneggiamento della memoria di Microsoft Office
...
### <a name="office-suite-non-security-updates"></a>Famiglia di prodotti Office: aggiornamenti non relativi alla sicurezza
-   Consente di correggere un problema a causa del quale, quando vengono distribuiti gli aggiornamenti con l'Interfaccia di gestione configurazione sistema a un client che esegue applicazioni di Office, l'aggiornamento non viene applicato dopo il riavvio del dispositivo.
...
-   L'opzione Aggiorna adesso è nascosta da File \> Account \> Opzioni di aggiornamento quando un oggetto COM di Office è abilitato in modo che gli aggiornamenti del client Office 365 vengano gestiti dall'Interfaccia di gestione configurazione sistema.
...
-   Consente di correggere un bug a causa del quale l'installazione degli aggiornamenti richiedeva un lungo periodo di tempo in determinati scenari. 
...
## <a name="version-1708-may-8"></a>Versione 1708: 8 maggio
...
## <a name="version-1705-may-8"></a>Versione 1705: 8 maggio
*Versione 1705 (Build 8201.2278)*

*Si tratta della versione di Deferred Channel che è disponibile da settembre 2017. Continuerà ad essere supportata e a ricevere aggiornamenti della sicurezza fino a luglio 2018. Tuttavia, ora è disponibile una nuova versione del canale semestrale, la 1708 (Build 8431.2250), che contiene nuove funzionalità, aggiornamenti di sicurezza e aggiornamenti non relativi alla sicurezza.*
...
## <a name="version-1708-april-10"></a>Versione 1708: 10 aprile
...
## <a name="version-1705-april-10"></a>Versione 1705: 10 aprile
*Versione 1705 (Build 8201.2272)*

*Si tratta della versione di Deferred Channel che è disponibile da settembre 2017. Continuerà ad essere supportata e a ricevere aggiornamenti della sicurezza fino a luglio 2018. Tuttavia, ora è disponibile una nuova versione del canale semestrale, la 1708 (Build 8431.2242), che contiene nuove funzionalità, aggiornamenti di sicurezza e aggiornamenti non relativi alla sicurezza.*
...
## <a name="version-1708-march-13"></a>Versione 1708: 13 marzo
...
## <a name="version-1705-march-13"></a>Versione 1705: 13 marzo
*Versione 1705 (Build 8201.2265)*

*Si tratta della versione di Deferred Channel che è disponibile da settembre 2017. Continuerà ad essere supportata e a ricevere aggiornamenti della sicurezza fino a luglio 2018. Tuttavia, ora è disponibile una nuova versione del canale semestrale, la 1708 (Build 8431.2236), che contiene nuove funzionalità, aggiornamenti di sicurezza e aggiornamenti non relativi alla sicurezza.*
...
## <a name="version-1705-february-13"></a>Versione 1705: 13 febbraio
*Versione 1705 (Build 8201.2258)*

*Si tratta della versione di Deferred Channel che è disponibile da settembre 2017. Continuerà ad essere supportata e a ricevere aggiornamenti della sicurezza fino a luglio 2018. Tuttavia, ora è disponibile una nuova versione del canale semestrale, la 1708 (Build 8431.2215), che contiene nuove funzionalità, aggiornamenti di sicurezza e aggiornamenti non relativi alla sicurezza.*
...
-   **L'operazione di modifica di un nuovo elemento è più accessibile:** utilizza i tasti di scelta rapida CTRL+E per modificare un nuovo elemento dalla casella combinata oppure dalla casella di riepilogo.
...
-   **Connettore Salesforce:** importa i dati oppure collega i dati archiviati in Salesforce. [Ulteriori informazioni](https://support.office.com/article/7375ffb6-1d6a-46f1-bb0c-c6ac3c58f5a0)

### <a name="access-non-security-updates"></a>Access: aggiornamenti non relativi alla sicurezza
-   Consente di risolvere un problema in cui se si tenta di selezionare il testo nella casella di testo di una casella combinata viene selezionato tutto il testo, anziché la parte selezionata.
-   Consente di risolvere un problema in cui una query non viene eseguita se la query presenta un unione con una chiave primaria di una tabella Microsoft Dynamics collegata.
...
-   **Condivisione delle query**: esporta qualsiasi definizione query in un file ODC (Office Database Connection), quindi condividilo nelle cartelle di lavoro o con altri utenti.
-   **Caricamento dei dati:** carica i dati da una query direttamente in Tabelle pivot o Grafici pivot senza dover salvare i dati nel modello di dati.
-   **Attività di un file condiviso:** seleziona il pulsante Attività nell'angolo superiore destro del file per visualizzare quando un file condiviso in OneDrive for Business o SharePoint è stato condiviso, modificato, rinominato o ripristinato.
...
-   **Funzionalità di importazione dei dati migliorata:** puoi importare e creare facilmente dati da diverse origini. Gestisci le query e le connessioni delle cartelle di lavoro con il riquadro laterale Query e collegamento e condividi le query con altri utenti tramite file ODC. [Ulteriori informazioni](https://support.office.com/article/ad78befd-eb1c-4ea7-a55d-79d1d67cf9b3)
-   **Modifiche nei file condivisi**: visualizza l'autore delle modifiche apportate alle cartelle condivise e ripristina le versioni precedenti. [Ulteriori informazioni](https://support.office.com/article/5c1e076f-a9c9-41b8-8ace-f77b9642e2c2)
-   **Selezione con Lazo tramite pulsante della penna:** utilizza i pulsanti della penna digitale supportati per eseguire una selezione con Lazo dell'inchiostro senza accedere alla barra multifunzione.
...
-   Consent di risolvere un problema per cui una copia di una tabella pivot in un'altra cartella di lavoro causa un arresto anomalo.
...
-   Consente di risolvere un problema per cui Excel si arresta in modo anomalo dopo aver utilizzato il pulsante Forme in una cartella di lavoro già chiusa.
...
-   **Configurazione di nuovi account:** imposta nuovi account con una nuova procedura guidata che richiede meno passaggi manuali.
-   **Finestra di dialogo Allega per link:** quando alleghi un link tramite l'opzione Allega file sulla barra multifunzione, puoi selezionare se aggiungerlo come link o come allegato. Se non desideri visualizzare sempre questa finestra di dialogo, vai su File \> Opzioni \> Generale e specifica in che modo allegare i link in "Opzioni allegato".
...
-   **Classificazioni aziendali per gruppi:** quando crei o modifichi un gruppo, puoi assegnare un livello di classificazione commerciale definito dall'amministratore tenant, come ad esempio Riservato, classificazione che viene poi visualizzata nell'intestazione del gruppo.
-   **Accesso guest ai gruppi di Office 365:** collabora con utenti esterni all'organizzazione autorizzandoli ad accedere alle conversazioni dei gruppi, ai file, agli inviti al calendario e al blocco appunti dei gruppi. [Ulteriori informazioni](https://support.office.com/article/bfc7a840-868f-4fd6-a390-f347bf51aff6)
...
### <a name="powerpoint-feature-updates"></a>PowerPoint: aggiornamenti delle funzionalità
-   **Inserimento di immagini online:** la nuova pagina di destinazione per selezionare immagini e informazioni sull'attribuzione è automaticamente inserita con l'immagine.
-   **Sottotitoli codificati per i video:** aggiungi sottotitoli codificati a un video per renderlo più accessibile. [Ulteriori informazioni](https://support.office.com/article/a16745e1-b3da-4428-b2a7-ff0c8b758d0b)
-   **Narrazione di una registrazione:** includi video di se stessi durante il commento quando effettui la registrazione di una presentazione. Le registrazioni possono includere animazioni, input penna, audio e video.
-   **Attività di un file condiviso:** seleziona il pulsante Attività nell'angolo superiore destro del file per visualizzare quando un file condiviso in OneDrive for Business o SharePoint è stato condiviso, modificato, rinominato o ripristinato.
...
-   **Modifiche nei file condivisi:**  visualizza l'autore delle modifiche apportate alle presentazioni condivise e ripristina le versioni precedenti. [Ulteriori informazioni](https://support.office.com/article/5c1e076f-a9c9-41b8-8ace-f77b9642e2c2)
...
-   [CVE-2017-8695](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2017-8695): vulnerabilità della divulgazione delle informazioni relative al componente grafica
-   [CVE-2017-8696](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2017-8696): esecuzione di codice remoto del componente grafica di Microsoft
...
-   Visualizza il numero di telefono del chiamante per le chiamate in arrivo gestite dall'Operatore automatico aziendale, se il nome dell'utente non è noto.
-   Aggiunge un'impostazione di accesso in banda che offre la limitazione "Tutti gli utenti (senza restrizioni)" come opzione per "Persone che non devono aspettare nella sala di attesa".
-   Aggiunge la possibilità di attivare o disattivare i video automatici per videochiamate P2P in VDIv2.
-   Consente di risolvere un problema a causa del quale numeri duplicati vengono visualizzati per i contatti nel menu a discesa della chiamata.
-   Consente di risolvere un problema a causa del quale i delegati vengono eliminati per gli utenti che passano da Skype for Business a Skype for Business Basic.
-   Consente di risolvere un problema a causa del quale l'impostazione Risulta non in linea non viene visualizzata quando si utilizzano i criteri client Attiva Risulta non in linea e URL stato personalizzato.
-   Ampliato il pulsante per partecipare alla riunione per correggere il troncamento di alcune lingue localizzate.
-   Aumenta la diffusione dei messaggi di alta priorità in chat.
-   Aggiunge tipi di estensione di file per Office e Skype for Business all'elenco di indirizzi bloccati per il trasferimento di file consentiti.
...
-   **Attività di un file condiviso:** seleziona il pulsante Attività nell'angolo superiore destro del file per visualizzare quando un file condiviso in OneDrive for Business o SharePoint è stato condiviso, modificato, rinominato o ripristinato.
-   **Collegamenti sicuri:** quando un utente fa clic su un collegamento, Office 365 Advanced Threat Protection (ATP) esamina il collegamento per verificare se è dannoso. Se il collegamento è ritenuto dannoso, l'utente viene reindirizzato a una pagina di avviso anziché all'URL di destinazione originale. [Ulteriori informazioni](https://support.office.com/article/dd6a1fef-ec4a-4cf4-a25a-bb591c5811e3)
-   **Modifiche nei file condivisi:** visualizza l'autore delle modifiche apportate ai documenti condivisi e ripristina le versioni precedenti. [Ulteriori informazioni](https://support.office.com/article/5c1e076f-a9c9-41b8-8ace-f77b9642e2c2)
...
-   Salvataggio di un documento come PDF salva il documento in versione 1.7 PDF.
...
-   Aggiunge support.to per consentire agli utenti che usano le versioni a 64 bit di Office di aprire i file macro che contengono i controlli mscomctl.ocx.
-   Migliora l'accessibilità dei controlli utilizzati in mscomctl.ocx.
...
## <a name="version-1705-january-9"></a>Versione 1705: 9 gennaio
*Versione 1705 (Build 8201.2217)*

*Si tratta della versione di Deferred Channel che è disponibile da settembre 2017. Continuerà ad essere supportata e a ricevere aggiornamenti della sicurezza fino a luglio 2018. Tuttavia, ora è disponibile una nuova versione del canale semestrale, la 1708 (Build 8431.2153), che contiene nuove funzionalità, aggiornamenti di sicurezza e aggiornamenti non relativi alla sicurezza.*
