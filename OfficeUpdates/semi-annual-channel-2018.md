...
Queste note sulle versioni forniscono informazioni sulle nuove caratteristiche, sugli aggiornamenti della sicurezza e non della sicurezza inclusi negli aggiornamenti del Canale semestrale per Office 365 ProPlus nel 2018. 
...
- Risolto un problema che causava la chiusura imprevista di Outlook durante l'aggiornamento di alcuni campi dei contatti.
- Risolve un problema che causava la visualizzazione di un messaggio di errore all'avvio della finestra di dialogo "Gestisci regole e avvisi".
- Risolve un problema che causava arresti anomali in Outlook durante l'esecuzione di alcuni componenti aggiuntivi.


## <a name="version-1708-december-11"></a>Version 1708: 11 dicembre
*Versione 1708 (Build 8431.2351)*
...
## <a name="version-1803-november-13"></a>Versione 1803: 13 novembre
*Versione 1803 (Build 9126.2315)*
...
- Questa modifica consente agli utenti di salvare tutti i file fisici in una condivisione di rete, inclusa un'unità di rete mappata. 

## <a name="version-1708-november-13"></a>Versione 1708: 13 novembre
*Versione 1708 (Build 8431.2329)*
...
## <a name="version-1803-october-9"></a>Version 1803: 9 ottobre
...
## <a name="version-1708-october-9"></a>Version 1708: 9 ottobre
...
-   Risolvere un problema in cui i file temporanei creati tramite il ripristino automatico durante il recupero di un documento non vengono mai eliminati.
...
-   Consente di correggere un problema per cui non è possibile aprire Word su un computer con Windows 7 se non è installatoAggiornamento per i clienti e diagnostica telemetriaInstallato
